...
gcc $CFLAG $CURR/strncat_test.c ft_strlen.c ft_strncat.c -I $DIR -o ft_strncat_test -D FT0
OK
printf "Compilation SYS0 (get (ft_)strncat of argv[2])"
gcc $CFLAG $CURR/strncat_test.c ft_strlen.c ft_strncat.c -I $DIR -o strncat_test -D SYS0
OK
TARG0="Hello World"
