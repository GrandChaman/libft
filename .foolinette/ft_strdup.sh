...
gcc $CFLAG $CURR/strdup_test.c ft_strcpy.c ft_strlen.c ft_strdup.c -I $DIR -o ft_strdup_test -D FT0
OK
printf "Compilation SYS0 (get (ft_)strdup of argv[2])"
gcc $CFLAG $CURR/strdup_test.c ft_strcpy.c ft_strlen.c ft_strdup.c -I $DIR -o strdup_test -D SYS0
OK
TARG="Hello World"
